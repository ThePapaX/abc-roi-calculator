...
import { InvestmentOption, InvestmentOptionGroup, InvestmentRowsState, rowValidationDictionary } from '../store/StoreDefs';
...
const InvestmentOptionsList: React.FC<InvestmentOptionsListProps> = (props => {
    ...
    }, [props.investmentAllocation.length, props.maxRowCount]);
